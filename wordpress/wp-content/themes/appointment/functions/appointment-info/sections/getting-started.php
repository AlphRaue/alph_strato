...
<div id="getting_started" class="appointment-tab-pane active">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h1 class="appointment-info-title text-center"><?php echo __('About Appointment Theme', 'appointment'); ?><?php if (!empty($appointment['Version'])): ?>
                        <sup id="appointment-theme-version"><?php echo esc_attr($appointment['Version']); ?> </sup><?php endif; ?>
                </h1>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="appointment-tab-pane-half appointment-tab-pane-first-half">
                    <img src="<?php echo esc_url(get_template_directory_uri()) . '/functions/appointment-info/img/appointment.png'; ?>"
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="appointment-tab-pane-half appointment-tab-pane-first-half">
                    ...
                    <a href="<?php echo 'https://webriti.com/appointment-free/'; ?>" target="_blank" class="info-block">
                        <div class="dashicons dashicons-desktop info-icon"></div>
                        <p class="info-text"><?php echo __('Lite Demo', 'appointment'); ?></p></a>

                    <a href="<?php echo 'https://webriti.com/demo/wp/appointment'; ?>" target="_blank"
                       class="info-block">
                        <div class="dashicons dashicons-desktop info-icon"></div>
                        <p class="info-text"><?php echo __('Pro Demo', 'appointment'); ?></p></a>

                    <a href="<?php echo 'https://webriti.com/help/category/themes/appointment/'; ?>" target="_blank"
                       class="info-block">
            ...
            <div class="col-md-6">
                <div class="appointment-tab-pane-half appointment-tab-pane-first-half">
                    ...
                    <a href="<?php echo 'https://webriti.com/appointment'; ?>" target="_blank" class="info-block">
                        <div class="dashicons dashicons-book-alt info-icon"></div>
                        <p class="info-text"><?php echo _e('Premium Theme Details', 'appointment'); ?></p></a>

                    <a href="<?php echo 'https://wordpress.org/support/view/theme-reviews/appointment'; ?>"
                       target="_blank" class="info-block">
