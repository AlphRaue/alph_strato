...
function appointment_pro_customizer($wp_customize)
{
    class WP_Pro_Customize_Control extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ?>
            <div class="pro-box">
                <a href="<?php echo 'http://webriti.com/appointment/'; ?>" target="_blank" class="upgrade"
                   id="review_pro"><?php _e('UPGRADE TO PRO', 'appointment'); ?></a>
    ...
    class WP_Review_Customize_Control extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ?>
            <div class="pro-box">
                <a href="<?php echo 'https://wordpress.org/support/view/theme-reviews/appointment#postform/'; ?>"
                   target="_blank" class="review" id="review_pro"><?php _e('ADD YOUR REVIEW', 'appointment'); ?></a>
            </div>
            <?php
        }
    }
    ...
    class WP_document_Customize_Control extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ?>
            <div class="pro-box">
            <a href="<?php echo 'http://webriti.com/help/'; ?>" target="_blank" class="document"
               id="review_pro"><?php _e('DOCUMENTATION', 'appointment'); ?></a>
