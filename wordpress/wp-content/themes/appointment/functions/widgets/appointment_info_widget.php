...
class appointment_info_widget extends WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>"
               ...
               value="<?php if ($title) echo esc_attr($title); else _e('Have a question? Call us now', 'appointment'); ?>"/>

        <h4 for="<?php echo $this->get_field_id('fa_icon'); ?>"><?php _e('FontAwesome icon', 'appointment'); ?></h4>
        <input class="widefat" id="<?php echo $this->get_field_id('fa_icon'); ?>"
               name="<?php echo $this->get_field_name('fa_icon'); ?>" type="text"
               value="<?php if ($fa_icon) echo esc_attr($fa_icon); else echo 'fa fa-phone'; ?>"/>
        <span><?php _e('Link to get FontAwesome icon', 'appointment'); ?><a
                    href="<?php echo 'http://fortawesome.github.io/Font-Awesome/icons/'; ?>"
                    target="_blank"><?php echo 'fa-icon'; ?></a></span>
        ...
        <input class="widefat" id="<?php echo $this->get_field_id('description'); ?>"
               ...
               value="<?php if ($description) echo esc_attr($description); else '+82 334 843 52'; ?>"/><br><br>
