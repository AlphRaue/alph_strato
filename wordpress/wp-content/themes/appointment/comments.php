            ...
            <div class="media-body">
                <div class="comment-detail">
                    ...
                    <h4 class="comment-detail-title"><?php comment_author(); ?><span class="comment-date"><a
                                    href="<?php echo get_comment_link($comment->comment_ID); ?>"><?php _e('Posted on', 'appointment'); ?><?php echo comment_time('g:i a'); ?><?php echo " - ";
...
if (have_comments()) { ?>
    ...
    <div class="comment-section">
        <div class="comment-title">
            <h3></i> <?php comments_number(__('No Comments so far', 'appointment'), __('1 Comment so far', 'appointment'), '% ' . __('Comments so far', 'appointment')); ?> </h3>
        </div>
